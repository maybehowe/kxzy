...
<div class="wrapper">
	<div class="top">
		<div class="content">
			<a href="#" class="logo"><img src="${contextPath }/front/images/logo.jpg" width="312" height="101" /></a>
			<div class="top_right">
				<div class="login">
					<input name="" type="text" class="login_name" />
					<input name="" type="password" class="login_pwd" />
					<input name="" type="submit" value="" class="login_sub" />
	...
	<div style="width:1050px; margin:0 auto;">
		<div class="building2">
			...
			<p>您可以：</p>
			<p>1.直接访问浙江省科普资源共享服务平台首页<a href="#">${contextPath }</a></p>
