 ...
 $(function() {
	 ...
	 $("#cate_name")
		    ...
		    .ajaxValidator({
				...
				data:{"editEducationCate":"${cate.cateName}","add_educationCate":false},
...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">编辑教育基地类别</div>
				<div class="line">教育基地类别详情：</div>
				  <form id="cate_Form"  action="${contextPath}/manage/education/category/submitEdit.rt" method="post">
