		...
		<div class="right">
			<div class="main">
				...
				<div class="line">图片编辑</div>
				  <form id="picture_Form" action="${contextPath}/manage/education/picture/submitEdit.rt" method="post">
					 ...
					 <table width="96%" border="0" class="data">
					  <tr>
						...
						<td width="210">
						  <img src="${contextPath}/manage/education/picture/image.rt?picId=${picture.id}" alt="..." style="max-width: 330px;max-height: 230px"/>
