...
function setCover(id){
	var url = "${contextPath}/manage/education/picture/setPictureSetCover.rt";
	var params = {
		"pictureId" : id,
	...
	<div class="content">
		...
		<div class="right">
			...
			<div class="main">
				...
				<table border="0" class="data" style="width: 96%;">
				  <tr>
				  ...
				  <tr>
					...
					<td>
					  <div style="width:670px; overflow: hidden;"><img src="${contextPath}/manage/education/picture/image.rt?picId=${picture.id}" alt="..." style="max-width: 670px;"></div>
					</td>
				  </tr>
				  <tr></tr>
				  <tr>
				    <th>缩略图：</th>
				    <td>
				      <img  src="${contextPath}/manage/education/picture/thumbnail.rt?picId=${picture.id}&size=176" alt="176">
	    			  <img  src="${contextPath}/manage/education/picture/thumbnail.rt?picId=${picture.id}&size=152" alt="152">
	    			  <img  src="${contextPath}/manage/education/picture/thumbnail.rt?picId=${picture.id}&size=128" alt="128">
	    			  <img  src="${contextPath}/manage/education/picture/thumbnail.rt?picId=${picture.id}&size=100" alt="100">
				    </td>
				  </tr>
				  <tr class="buttom">
					<th scope="row" align="right"></th>
					<td>
						<a href="javascript:setCover(${picture.id})" class="add_but fl" style="height:24px;border:0px;font-size:14px;color:white;font-weight:bold;">设封面</a>
						<a href="javascript:window.history.back();" class="add_but fl" style="height:24px;border:0px;font-size:14px;color:white;font-weight:bold;">返 回</a>
					</td>
				  </tr>
				</table>
			</div>
