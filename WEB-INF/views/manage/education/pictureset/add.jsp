...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">添加教育基地图集</div>
				<div class="line">教育基地图集详情：</div>
				  <form id="pictureset_Form"  action="${contextPath}/manage/education/pictureset/submitAdd.rt" enctype="multipart/form-data" method="post">
					 ...
					 <table width="96%" border="0" class="data">
					  <tr>
						...
						<td width="330"><input type="text"  class="text" id="pictureset_name" name="pictureset.name" /></td>
						<td><span class="fl" id="pictureset_nameTip"></span></td>
					  </tr>
					  <tr>
						<th scope="row" width="110"><span style="color:red;">*</span> 图集类型：</th>
						<td>
						...
						<td><span class="fl" id="pictureset_cateIdTip"></span></td>
					  </tr>
					   <tr>
					  ...
					  <tr>
						...
						<td><textarea name="pictureset.description" id="pictureset_description" cols="40" rows="19"></textarea></td>
