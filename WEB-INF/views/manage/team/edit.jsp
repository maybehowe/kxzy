 ...
 $(function() {
	 ...
	 $("#team_name")
		    ...
		    .ajaxValidator({
				...
				async : true,
				type : "post",
				url : "${contextPath}/manage/team/validateTeamName.rt?team.parentId="+"${team.parentId}",
				data:{"editTeam":"${team.teamName}","add_team":false},
...
<div class="wrapper" style="min-width:100%;">
	<div class="content" style="min-width:100%;">
		...
		<div class="tit">科普团体-添加</div>
		  <form id="team_Form" action="${contextPath}/manage/team/submitEdit.rt" enctype="multipart/form-data" method="post">
		     <input type="hidden" class="text" id="team_id" name="team.id" value="${team.id}"/>
			 <table width="96%" border="0" class="data">
			  <tr>
				<th scope="row" width="110"><span style="color:red;">*</span> 团体名称：</th>
				<td width="210"><input type="text" class="text" id="team_name" name="team.teamName" value="${team.teamName}"/></td>
				<td><span class="fl" id="team_nameTip"></span></td>
			  </tr>
			  <tr>
				<th scope="row" width="110"><span style="color:red;">*</span> 团体地址：</th>
				<td><input type="text" class="text" id="team_teamAddress" name="team.teamAddress" value="${team.teamAddress}"/></td>
				<td><span class="fl" id="team_teamAddressTip"></span></td>
			  </tr>
			  <tr>
				<th scope="row" width="110">联系方式：</th>
				<td><input type="text" class="text" id="team_contact" name="team.contact" value="${team.contact}" /></td>
			  ...
			  <tr>
			   ...
			   <tr>
				...
				<td><input type="text" class="text" id="team_linkUrl" name="team.linkUrl" value="${team.linkUrl}"/></td>
				<td><span class="fl" id="team_linkUrlTip"></span></td>
			  </tr>
			  <tr>
				<th scope="row">团体简称：</th>
				<td>
                    <textarea rows="8" cols="39" id="team_shortName" name="team.shortName" style="overflow-y:auto" class="text_beiz" >${team.shortName}</textarea>
                </td>
			  ...
			  <tr>
				<th scope="row">备注：</th>
				<td>
                    <textarea rows="8" cols="39" id="team_remark" name="team.remark" style="overflow-y:auto" class="text_beiz" >${team.remark}</textarea>
                </td>
                <td><span class="fl" id="team_remarkTip"></span></td>
			  </tr>
			  <tr>
				<th scope="row" width="110">创建时间：</th>
				<td>
				   <input type="hidden" class="text" id="team_createTime" name="team.createTime" value="${team.createTime}" />
