	...
	<div class="content">
		...
		<div class="right">
			...
			<div class="main">
				...
				<form id="videoForm" name="videoForm" action="${contextPath}/manage/museum/save.rt" method="post" enctype="multipart/form-data">
				<input type="hidden" name="viewId" value="${viewId }" />
				<input type="hidden" name="leftId" value="${leftId }" />
				<table width="96%" border="0" class="data">
				  <tr>
					<td colspan="2">
						<jsp:include page="/WEB-INF/views/manage/museum/video.jsp" />
					</td>
				  </tr>
				  <tr>
				  	<td>
