...
<script type="text/javascript" language="javascript">
 $(function() {
	 ...
	 $("#museum_name")
	   ...
	   $("#museum_cityName").val("${museum.cityName}");
    });
		...
		<div class="content">
			...
			<div class="right">
				<div class="main">
					...
					<form id="museum_Form"  action="${contextPath}/manage/museum/submitEdit.rt" method="post">
					     <input type="hidden" name="museum.id" value="${museum.id }" />
						 ...
						 <table width="96%" border="0" class="data">
						 	<tr>
								...
								<td>
									<input type="text"  class="text" id="museum_name" name="museum.name" value="${museum.name}" />
								</td>
								<td>
						  	...
						  	<tr>
								...
								<td width="330">
									<select name="museum.type" id="museum_type">
										...
										<option value="1" ${museum.type eq 1 ? 'selected' :'' }>省内场馆</option>
										<option value="2"${museum.type eq 2 ? 'selected' :'' }>国内场馆</option>
									</select>
								</td>
								<td colspan="2">
							...
							<tr id="linkRow">
								...
								<td>
									<input type="text"  class="text" id="museum_link" name="museum.link" value="${museum.link }"/>
								</td>
								<td>
						  	...
						  	<tr>
								...
								<td>
							        <textarea name="museum.descript" id="museum_descript" cols="40" rows="19">${rt:escapeHtml(museum.descript)}</textarea>
								</td>
								<td colspan="2">
