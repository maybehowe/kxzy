...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">友情链接类别类别</div>
				<div class="line">友情链接类别类别详情：</div>
				  <form id="cate_Form"  action="${contextPath}/manage/link/category/submitAdd.rt" method="post">
