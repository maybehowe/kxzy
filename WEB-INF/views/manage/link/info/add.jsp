		...
		<div class="right">
			<div class="main">
				...
				<div class="line">友情链接详情：</div>
				  <form id="link_Form"  action="${contextPath}/manage/link/info/submitAdd.rt" enctype="multipart/form-data" method="post">
					 ...
					 <table width="96%" border="0" class="data">
					  <tr>
						...
						<td width="330"><input type="text" class="text" id="link_name" name="link.linkName" /></td>
					  ...
					  <tr>
						...
						<td><input type="text" class="text" id="link_address" value="http://" name="link.address"/></td>
						<td><span class="fl" id="link_addressTip"></span></td>
					  </tr>
					  <!-- <tr>
						<th scope="row" width="110">主办单位：</th>
						<td><input type="text" class="text" id="link_organizer" name="link.organizer" /></td>
						<td><span class="fl" id="link_organizerTip"></span></td>
					  </tr>
					  <tr>
						<th scope="row">简介：</th>
						<td>
                            <textarea rows="8" cols="39" id="link_introduction" name="link.introduction" style="overflow-y:auto" class="text_beiz" ></textarea>
                        </td>	
