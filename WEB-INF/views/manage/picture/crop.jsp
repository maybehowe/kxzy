		...
		<div class="right">
			...
			<div class="main">
				...
				<div class="line">裁剪--主页置顶：</div>
				   <div>
	    			<img id="originalImage" src="${contextPath}/manage/picture/image.rt?picId=${picture.id}" alt="..." style="max-width:1215px"> 
	    		  </div>
				  <div id="preview-pane" style="margin-top:3px;">
					<div class="preview-container">
						<img src="${contextPath}/manage/picture/image.rt?picId=${picture.id}" class="jcrop-preview" alt="Preview"/>
					</div>
				</div>
		    	<div style="margin-top: 10px;">
		    		<div>
		    			<form action="${contextPath}/manage/picture/submitCrop.rt" method="post">
