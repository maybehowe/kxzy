...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">专家类别</div>
				<div class="line">专家类别详情：</div>
				  <form id="cate_Form"  action="${contextPath}/manage/expert/category/submitAdd.rt" method="post">
