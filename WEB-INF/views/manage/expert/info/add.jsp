		...
		<div class="right">
			<div class="main">
				...
				<div class="line">专家详情：</div>
				  <form id="expert_Form"  action="${contextPath}/manage/expert/info/submitAdd.rt" enctype="multipart/form-data" method="post">
					 ...
					 <table width="96%" border="0" class="data">
					  <tr>
						...
						<td width="330"><input type="text" class="text" id="user_name" name="expert.userName" /></td>
					  ...
					  <tr>
						...
						<td>
						   <textarea name="expert.introduction" id="expert_introduction" cols="40" rows="19"></textarea>
						</td>
