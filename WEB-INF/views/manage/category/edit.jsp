	...
	<div class="content">
		...
		<div class="right">
			...
			<div class="main">
				...
				<input type="hidden" name="columnId" value="${category.columnId }" />
				<table width="96%" border="0" class="data">
				  <tr>
					<th scope="row" width="110"><span style="color:red;">*</span> 频道名称：</th>
					<td><input name="category.name" type="text" class="text" id="txtname" value="${category.name }" /></td>
					<td><span class="fl" id="txtnameTip"></span></td>
				  </tr>
				  <tr>
					<th scope="row" align="right"><span style="color:red;">*</span> 排序号：</th>
					<td><input name="category.sortId" type="text" class="text" id="txtsortId" value="${category.sortId }" /></td>
					<td><span class="fl" id="txtsortIdTip"></span></td>
				  </tr>
				   <tr>
					<th scope="row" align="right">描述：</th>
					<td><input name="category.description" type="text" class="text" id="txtdescription" value="${category.description }" /></td>
