...
function setCover(id){
	var url = "${contextPath}/manage/exhibit/picture/setPictureSetCover.rt";
	var params = {
		"pictureId" : id,
			...
			<div class="main">
				...
				<table border="0" class="data" style="width: 96%;">
				  ...
				  <tr>
					...
					<td>
					  <div style="width:670px; overflow: hidden;"><img src="${contextPath}/manage/exhibit/picture/image.rt?picId=${picture.id}" alt="..." style="max-width: 670px;"></div>
					</td>
				  </tr>
				  <tr></tr>
				  <tr>
				    <th>缩略图：</th>
				    <td>
				      <img  src="${contextPath}/manage/exhibit/picture/thumbnail.rt?picId=${picture.id}&size=176" alt="176">
	    			  <img  src="${contextPath}/manage/exhibit/picture/thumbnail.rt?picId=${picture.id}&size=152" alt="152">
	    			  <img  src="${contextPath}/manage/exhibit/picture/thumbnail.rt?picId=${picture.id}&size=128" alt="128">
	    			  <img  src="${contextPath}/manage/exhibit/picture/thumbnail.rt?picId=${picture.id}&size=100" alt="100">
				    </td>
				  </tr>
				  <tr class="buttom">
