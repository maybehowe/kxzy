 ...
 $(function() {
	 ...
	 $("#pictureset_name")
	        ...
	        .inputValidator({
	        	...
	        	onErrorMax:"展品图集名称长度不能超过50个字符",
		        onError:"展品图集名称不能为空,请确认"
	        	});
	 $("#pictureset_cateId")
     .formValidator({
	         onShow:"请选择展品类型",
...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">添加展品图集</div>
				<div class="line">展品图集详情：</div>
				  <form id="pictureset_Form"  action="${contextPath}/manage/exhibit/pictureset/submitAdd.rt" enctype="multipart/form-data" method="post">
					 ...
					 <table width="96%" border="0" class="data">
					  ...
					  <tr>
						<th scope="row" width="110"><span style="color:red;">*</span> 展品图集类型：</th>
						<td>
