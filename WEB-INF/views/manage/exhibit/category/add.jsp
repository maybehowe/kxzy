...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">展品类别</div>
				<div class="line">展品类别详情：</div>
				  <form id="cate_Form"  action="${contextPath}/manage/exhibit/category/submitAdd.rt" method="post">
