			...
			<div class="main">
				...
				<table width="96%" border="0" class="data">
				  <tr>
					...
					<td width="330"><input name="subject.name" type="text" class="text" id="name" /></td>
					<td><span class="fl" id="nameTip"></span></td>
				  </tr>
				  <tr>
					<th scope="row" align="right">备注：</th>
					<td><input name="subject.des" type="text" class="text" id="txtremark" /></td>
