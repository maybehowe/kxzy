	 ...
	 $("#pictureset_channelId")
       .formValidator({
	     ...
	     .inputValidator({
	       ...
	       .regexValidator({regExp:"notempty",dataType:"enum",onError:"非空"});
	 $("#pictureset_name")
	        .formValidator({
...
<div class="wrapper">
	...
	<jsp:include page="/WEB-INF/views/manage/common/left.jsp" />
		<div class="right">
			<div class="main">
				<div class="tit">添加科普图集</div>
				<div class="line">科普图集详情：</div>
				  <form id="pictureset_Form"  action="${contextPath}/manage/pictureset/submitAdd.rt" enctype="multipart/form-data" method="post">
					 ...
					 <table width="96%" border="0" class="data">
					  <tr>
						...
						<td width="330">
						  <input type="hidden" class="text" id="pictureset_channelId" name="pictureset.channelId" style="width: 190px"/>
						  <input type="text" class="text" id="picturesetName" name="picturesetName" style="width: 190px" onfocus="this.blur()"/>
						...
						<td><input type="text"  class="text" id="pictureset_name" name="pictureset.name" /></td>
					  ...
					  <tr>
					   ...
					   <td colspan="2"><span class="fl" id="pictureset_sourceIdTip"></span></td>
						...
						<td>
						  <input type="radio" id="pictureset_isPictureDesc" name="pictureset.isPictureDesc" checked="checked" value="${yes}"/>是&nbsp;
						  <input type="radio" id="pictureset_isPictureDesc" name="pictureset.isPictureDesc" value="${no}"/>否
						</td>
						<td><span class="fl" id="pictureset_isPictureDescTip"></span></td>
					  </tr>
					  <tr>
						<th scope="row" align="right"><span style="color:red;">*</span> 简介：</th>
						<td><textarea name="pictureset.description" id="pictureset_description" cols="40" rows="9"></textarea></td>
						<td colspan="2"><span class="fl" id="pictureset_descriptionTip"></span></td>
					  </tr>
					  <tr class="buttom">
						<th scope="row" align="right"></th>
						<td colspan="2">
							<input type="submit" id="submit_btn" value="下一步" class="add_but fl" />
