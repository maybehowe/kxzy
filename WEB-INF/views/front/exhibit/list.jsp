			    ...
			    <ul class="cp_two">
			       <c:forEach items="${page.results }" var="ps">
			          <li>
			        	...
			        	<img src="${contextPath}/front/exhibit/imageBig.rt?picId=${ps.isCover}" class="img" /></a>
			            <h3><a href="${contextPath }/front/exhibit/detail.rt?id=${ps.id}&columnId=${columnId}">${ps.name}</a></h3>
			          </li>
			       </c:forEach>
			    </ul>
  				<jsp:include page="../common/page.jsp" >
				<jsp:param value="${contextPath }/front/exhibit/list.rt" name="pageUrl"/>
