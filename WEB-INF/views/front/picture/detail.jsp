...
<div class="wrapper">
	...
	<div class="content">
				...
				<div class="panel panel-default" style="height: 100%">
					...
					<div class="panel-body">
						...
						<c:forEach items="${picList}" var="pic">
				            <a href="${contextPath }/front/picture/image.rt?picId=${pic.id}">
				                <img 
				                    src="${contextPath }/front/picture/thumbnail.rt?picId=${pic.id}&size=176"
				                    data-title=" "
		...
		<%-- <div class="tuji">
			...
			<a href="${contextPath }/front/picture/detail.rt?id=${prevPic.id }&columnId=${columnId }" style=" color: #1E5DA2">
			...
			<a href="${contextPath }/front/picture/detail.rt?id=${nextPic.id }&columnId=${columnId }" style=" color: #1E5DA2;">
