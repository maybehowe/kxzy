	...
	<div class="content">
		...
		<div class="video_list_main">
			<div class="list_main_top">
				...
				<div class="register_process"><img src="${contextPath}/front/images/register_13.jpg" width="955" height="27" /></div>
				<div class="register_ok"><img src="${contextPath}/front/images/register_10.jpg" /></div>
			</div>
		</div>
