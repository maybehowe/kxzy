			...
			<div class="main">
			    ...
			    <ul class="cp_two">
			       <c:forEach items="${page.results }" var="expert">
			          <li>
			        	<a href="${contextPath }/front/expert/detail.rt?id=${expert.id}&columnId=${columnId}">
			        	<img src="${contextPath }/${empty expert.thumbnailPath ? expert.pictureUrl : expert.thumbnailPath}" class="img" /></a>
			            <h3><a href="${contextPath }/front/expert/detail.rt?id=${expert.id}&columnId=${columnId}">${expert.userName}</a></h3>
			          </li>
			       </c:forEach>
			    </ul>
  				<jsp:include page="../common/page.jsp" >
				<jsp:param value="${contextPath }/front/expert/list.rt" name="pageUrl"/>
